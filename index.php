...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Purva Pet Care Center</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
    ...
    <img src="https://thumbs.dreamstime.com/b/happy-pets-husky-dog-british-cat-happy-pets-cat-dog-theme-close-up-portrait-isolated-white-background-119408263.jpg" style="width: 300px; height: 300px; border-radius: 10px; box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.3); transform: perspective(800px) rotateX(10deg);" alt="" />
    <h3>Welcome</h3>
</div>
